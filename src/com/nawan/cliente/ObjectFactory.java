 ...
 * generated in the com.nawan.cliente package. 
...
public class ObjectFactory {
    ...
    private final static QName _NomeResponse_QNAME = new QName("http://nawan.com/", "nomeResponse");
    private final static QName _Calcula_QNAME = new QName("http://nawan.com/", "calcula");
    private final static QName _Nome_QNAME = new QName("http://nawan.com/", "nome");
    private final static QName _CalculaResponse_QNAME = new QName("http://nawan.com/", "calculaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.nawan.cliente
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://nawan.com/", name = "nomeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://nawan.com/", name = "calcula")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://nawan.com/", name = "nome")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://nawan.com/", name = "calculaResponse")
